...
//get req.body from the parser, which takes the buffer and read it and save it into req.body, a json object
...
router.get('/api/notes', (req, res) => {
  ...
  if(id) {
    ...
    if (note) {
      ...
      sendStatus(res, 400, 'invalid note');
    }
  } else {
